 ...
 */
var SyncPlaybackPlugin = /** @class */ (function (_super) {
    __extends(SyncPlaybackPlugin, _super);
    /**
                    ...
                    switch (_a.label) {
                        ...
                        case 2:
                            ...
                            setInterval(function () {
                                console.log({ currentTime: _this.player.currentTime() });
                            }, 1000);
                            console.dir({ serverDate: serverDate, localDate: localDate });
                            return [2 /*return*/];
                    }
                });
            }); })();
